        ...
        if (isdigit(input[0])) // якщо введене значення (тобто 1 символ чого значення) є числом, то прога буде працювати
        {
            ...
            case 1:
                ...
                do
                {
                    ...
                    if (isdigit(input[0])) // якщо введене значення (тобто 1 символ чого значення) є числом, то прога буде працювати
                    {
                        ukrMenu = stoi(input); // перетворюю рядок інпут на ціле число (стрінг в інт) та присвоюю його змінній, яку буду використовувати в блоці світч
                        ...
                        case 1:
                        {
                            ...
                            if (!cin.is_open())
                            {
                                cerr << "\nУ вас немає файлу «mapa.txt»!" << endl;
                                break;
                            }
                            ...
                            {
                                cerr << "Вказівок не може бути менше 0 чи більше 40, слідуйте інструкціям!" << endl;
                                break;
                            } // якщо кількість вказівок файлу не відповідає кількості вказівок, дозволених інструкцією – у файл буде написана помилка
                            ...
                            for (int i = 1; i <= actions; i++)
                            {
                                ...
                                {
                                    cerr << "Число-напрямок може бути від 1 до 8 включаючи. Слідуйте інструкціям!" << endl;
                                    cout.close();
                                    cin.close();
                                    break;
                                ...
                                {
                                    cerr << "Число кроків може бути від 1 до 1000. Слідуйте інструкціям!" << endl;
                                    cout.close();
                                    cin.close();
                                    break;
                        ...
                        case 2:
                        {
                            ...
                            if (!error) // якщо немає помилок про напрямок/кроки
                            {
                                ...
                                cout.precision(3); // кількість знаків після коми, фіксед треба для того, щоб число не окргулялось до менших значень
                                cout << fixed << "\nСкарб знаходиться за координатами: " << endl
                                     << "X = " << X << " "
                                     << "Y = " << Y << endl;
                            }
                            break;
                        ...
                        case 4:
                        {
                            ...
                            do
                            {
                                ...
                                cout << "3. Повернути колір консолі до початкового значення " << endl;
                                cout << "4. Повернутись до головного меню " << endl;
                                cout << "Ваш вибір: ";
                                cin >> input;
                                ...
                                if (isdigit(input[0])) // якщо введене значення (тобто 1 символ чого значення) є числом, то прога буде працювати
                                {
                                    ...
                                    {
                                        system("cls"); // очистка консолі
                                        cout << "\nВведіть бажаний розміру шрифту: ";
                                        cin >> input;

                                        if (isdigit(input[0])) // якщо введене значення (тобто 1 символ чого значення) є числом, то прога буде працювати
                                        {
                                            fontSize = stoi(input); // перетворюю рядок інпут на ціле число (стрінг в інт) та присвоюю його змінній, яку буду використовувати в блоці світч
                                        ...
                                        {
                                            system("cls");
                                            cerr << "\nБудь ласка, введіть число!" // якщо 1 символ введеного значення інпут НЕ є потрібним числом, то виведе прохання написати нормально
                                                 << endl;
                                            break;
                                        }
                                    }
                                    case 3:
                                    {
                                        ...
                                        cout << "\nТепер консоль виглядає як раніше." << endl;
                                        break;
                                    }
                                    case 4:
                                    {
                                ...
                                {
                                    system("cls");
                                    cerr << "\nБудь ласка, напишіть 1, 2 чи 3!" // якщо 1 символ введеного значення інпут НЕ є потрібним числом, то виведе прохання написати нормально
                                         << endl;
                                }
                            } while (appearence != 3);
                            break;
                    ...
                    {
                        system("cls");
                        cerr << "\nБудь ласка, напишіть 1, 2, 3, 4 чи 5!" // якщо 1 символ введеного значення інпут НЕ є потрібним числом, то виведе прохання написати нормально
                             << endl;
                    }
                } while (ukrMenu != 5);
                ...
                do
                {
                    ...
                    if (isdigit(input[0]))
                    {
                        ...
                        case 1:
                        {
                            ...
                            if (actions <= 0 || actions > 40)
                            {
                                cerr << "The guidelines cannot be less than 0 or more than 40, follow the instructions!" << endl;
                                break;
                            ...
                            for (int i = 1; i <= actions; i++)
                            {
                                ...
                                if (direction <= 0 || direction > 8)
                                {
                                    cerr << "The direction number can be from 1 to 8. Follow the instructions!" << endl;
                                    cout.close();
                                    cin.close();
                                    break;
                                } // якщо напрямок не відповідає дозволеним інструкцією – у файл виведеться відповідна помилка
                                ...
                                if (steps <= 0 || steps > 1000)
                                {
                                    cerr << "The number of steps from 1 to 1000. Follow the instructions!" << endl;
                                    cout.close();
                                    cin.close();
                                    break;
                                } // якщо кількість кроків не відповідає дозволеним інструкцією – у файл виведеться відповідна помилка
                        ...
                        case 4:
                        {
                            ...
                            do
                            {
                                ...
                                if (isdigit(input[0])) // якщо введене значення (тобто 1 символ цього значення) є числом, то прога буде працювати
                                {
                                    appearence = stoi(input); // перетворюю рядок інпут на ціле число (стрінг в інт) та присвоюю його змінній, яку буду використовувати в блоці світч
                                    ...
                                    case 2:
                                    {
                                        ...
                                        {
                                            system("cls");
                                            cerr << "\nPlease enter a number!" // якщо 1 символ введеного значення інпут НЕ є потрібним числом, то виведе прохання написати нормально
                                                 << endl;
                                            break;
                                        }
                                    }
